...
function renderNavbar(container) {
  container.innerHTML = `
    <nav class="site-nav" aria-label="Main navigation">
      <a class="site-nav__logo" href="index.html" aria-label="Northern Lights Media home">
        <img src="Assets/NLM_Logo_A_Bordered.png" alt="Northern Lights Media" />
      </a>
      ...
      <div class="site-nav__menu" id="site-menu">
        ${navItems.map((item) => `<a href="${item.href}">${item.label}</a>`).join("")}
           <div class="site-nav__join-group">
             <a class="site-nav__join" href="mailto:northernlightsmedia@nku.edu">Join the club <span aria-hidden="true">↗</span></a>
